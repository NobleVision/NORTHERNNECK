  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white p-8">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-xl opacity-90">Rental Booking System with Cloudinary Integration</p>
          </div>
          <button
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        {/* Demo Star Rating Component */}
        <Card>
          <CardHeader>
            <CardTitle>Interactive Star Rating Demo</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <p className="text-sm font-medium mb-2">Click to rate:</p>
              <StarRating 
                rating={0} 
            ...
            <div>
              <p className="text-sm font-medium mb-2">Read-only ratings:</p>
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  <StarRating rating={2} readonly size="sm" />
